...
![rsTerrainAnalysis 地形分析 Eto 对话框与结果预览](../assets/rsTerrainAnalysis/image1.jpg)
*Eto 地形分析窗口：选择分析类型（高程/坡向/坡度/凹凸/粗糙度/积水风险/适建性/地形曲率/汇流量/侵蚀风险/建筑朝向适宜性）、渐变颜色与半球朝向，右侧实时预览色带；确认后生成按所选类型着色的地形网格并附带数值图例*
