...
![双层网架 Eto 对话框与生成效果](../assets/rsSpaceTruss/image1.png)
*Eto「双层网架」窗口：选择基础 Mesh 后设置结构类型（单层/双层）、双层模式（对应节点连接 / 面斜杆+Dual 上弦）、间隙距离、偏移距离、管半径、节点半径，并支持合并为单个 Mesh，实时预览并生成网架（杆件与节点）*
