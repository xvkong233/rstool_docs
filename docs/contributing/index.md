...
仓库内置了两个模板（反馈入口不提供空白 Issue，二选一即可），照着提示填写：

- **🐛 Bug 报告**：文档内容有误（命令描述、参数表、交互流程、配图）或站点
  功能异常（导航、搜索、样式）；
- **🚀 功能建议**：希望新增或改进的内容与站点功能。
...
- **截图**：直接把图片粘贴进输入框即可上传；
- **你的环境**：Rhino 版本、RsTool 版本（内容问题适用），站点问题可附上浏览器。
...
- **使用交流**：RsTool 插件本身的使用问题建议前往微信用户群交流；
