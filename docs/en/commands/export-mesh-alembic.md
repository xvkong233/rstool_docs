...
![The icons and prompts of the Export Mesh Alembic operator on the Grasshopper canvas (including running alarm status)](../../assets/Export Mesh Alembic/image1.jpg)
...
| Cancel export | Cancel | Bool | false | True / False | True A rising edge cancels the export in progress and cleans up the temporary .RsTool.&lt;guid&gt;.tmp file |
