...
![Icon](../../assets/gh-icons/CloseAllGhFile_24.png)

**Function**: Closes all documents open in the current Grasshopper session.
...
| --- | --- | --- | --- | --- | --- |
| Whether to close all Grasshopper documents | CloseAllGHDocuments | Boolean | No | single value |  |
