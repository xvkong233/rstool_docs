...
![Icon](../../assets/gh-icons/CurvsSplitAtIntersection_24.png)

**Function**: Split multiple curves where they intersect.
...
| --- | --- | --- | --- | --- | --- |
| Curves to split at their intersections | Curves | Curve |  | list |  |
